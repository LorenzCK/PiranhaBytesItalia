        ...
        <div class="row">
          <div class="col-sm-6 access-links">
            <ul>
              ...
              <li class="icon-list">
                  <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/resources/icon-facebook-black.png" alt="Facebook icon" /></a>
                  <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/resources/icon-youtube-black.png" alt="Facebook icon" /></a>
                  <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/resources/icon-googleplus-black.png" alt="Facebook icon" /></a>
                  <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/resources/icon-rss-black.png" alt="Facebook icon" /></a>
              </li>
            </ul>
          </div>

          <div class="col-sm-6 copyright">
              <p>&copy;&nbsp;Piranha Bytes Italia.</p>
